        ...
        <main className="flex-1 p-6 lg:p-8 xl:p-12">
          <div className="w-full max-w-7xl mx-auto space-y-8">
            ...
            `}>
              ...
              <div className="absolute top-0 right-0 w-96 h-96 bg-secondary-purple/3 rounded-full blur-3xl animate-float" />
              <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary-cyan/3 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
